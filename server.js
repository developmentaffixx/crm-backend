...
const otherCreditsRoutes       = require('./src/routes/otherCredits.routes');
...
const introDocumentsRoutes   = require('./src/routes/introDocuments.routes');
...
app.use('/api/other-credits',         otherCreditsRoutes);
...
app.use('/api/intro-documents',         introDocumentsRoutes);
