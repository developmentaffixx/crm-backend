...
// GET /api/ibrs-settings — list all IBRS configs (optionally ?industry_id=X)
router.get('/', controller.list);

// GET /api/ibrs-settings/project/:projectId — get IBRS sections for a specific project
router.get('/project/:projectId', param('projectId').isInt(), controller.getByProject);

// GET /api/ibrs-settings/:id — get single IBRS config
